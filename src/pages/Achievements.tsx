...
<<<<<<< HEAD
      <section className="bg-[#00123a] text-white py-20 relative overflow-hidden">
        ...
        <div className="container-main text-center relative z-10">
          <h1 className="text-[#ed8901] mb-6 text-5xl md:text-6xl font-extrabold tracking-tight">Achievements</h1>
...
=======
      <section className="bg-primary text-white py-20 relative overflow-hidden">
        ...
        <div className="container-main text-center relative z-10">
          ...
          <p className="text-white opacity-90 max-w-2xl mx-auto text-xl md:text-2xl font-medium">Coming Soon...</p>
