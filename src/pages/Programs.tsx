      ...
      <section className="bg-[#00123a] text-white py-20 relative overflow-hidden">
        ...
        <div className="container-main text-center relative z-10">
          ...
          <p className="opacity-90 max-w-3xl mx-auto text-xl md:text-2xl font-medium italic">
            "Discover the programs driving real, lasting change in our communities."
          </p>
        </div>
      </section>
        ...
        <div className="bg-white rounded-xl shadow-lg border border-[#c5c6cf] card-content md:p-8">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-end">
            <div className="md:col-span-6">
              <label className="block text-sm font-bold text-[#1a1c1c] mb-2">Search Programs</label>
              <div className="flex">
                <input className="flex-1 border-[#c5c6cf] focus:border-[#00123a] focus:ring-[#00123a] rounded-l-lg bg-[#f3f3f4] text-[#1a1c1c] py-2.5 px-4 outline-none border" placeholder="Search programs..." type="text"/>
