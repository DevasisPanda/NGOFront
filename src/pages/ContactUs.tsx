...
const ContactUs: React.FC = () => {
  ...
  return (
    <div className="flex-grow bg-white">
      {/* Contact Info Cards */}
      <section className="bg-white pt-20 fade-in-section opacity-0 translate-y-5 transition-all duration-800 ease-out [&.is-visible]:opacity-100 [&.is-visible]:translate-y-0">
      ...
      <section className="bg-white py-20 fade-in-section opacity-0 translate-y-5 transition-all duration-800 ease-out [&.is-visible]:opacity-100 [&.is-visible]:translate-y-0">
        <div className="container-main">
          <div className="grid lg:grid-cols-2 gap-12">
            {/* Left Column: Map */}
            <div className="flex flex-col">
              <div className="bg-[#ed8901] px-6 py-4 rounded-t-xl">
                <h2 className="text-white text-2xl font-extrabold tracking-wide text-center">Locate Us</h2>
              </div>
              <div className="border-2 border-t-0 border-[#e2e2e2] rounded-b-xl overflow-hidden shadow-sm h-[600px]">
                <iframe 
                  ...
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d113911.33230626354!2d80.87114175317663!3d26.848596482161676!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x399bfd991f32b16b%3A0x93ccba8909978be7!2sLucknow%2C%20Uttar%20Pradesh!5e0!3m2!1sen!2sin!4v1711234567890!5m2!1sen!2sin"
                  title="Google Maps location of Valmiki Samaj Charitable Trust"
                ></iframe>
              </div>
            </div>
            ...
            <div className="bg-white border-2 border-[#e2e2e2] rounded-xl p-8 shadow-sm">
              ...
              <form action="#" className="space-y-6">
                ...
                <button className="w-full bg-[#00123a] text-white py-4 rounded-lg font-bold text-lg hover:bg-opacity-90 transition-all shadow-md flex items-center justify-center gap-2 group" type="submit">
      ...
      <section className="bg-[#00123a] py-12 fade-in-section opacity-0 translate-y-5 transition-all duration-800 ease-out [&.is-visible]:opacity-100 [&.is-visible]:translate-y-0">
        <div className="container-main text-center flex flex-col md:flex-row items-center justify-between">
          ...
          <Link className="bg-[#ed8901] text-[#00123a] px-8 py-4 rounded-full font-bold text-lg hover:opacity-90 transition-opacity inline-flex items-center gap-2" to="/donate">
            <span className="material-symbols-outlined">volunteer_activism</span> Donate Us Now
          </Link>
        </div>
      </section>
    </div>
